...
app.post('/signup', async (req, res) => {
    ...
    const hashedpasswored = bcrypt.hashSync(passwored, salt)
    try {
        const signUp = await pool.query(`INSERT INTO users (email, hashed_pass) VALUES($1, $2)`, [email, hashedpasswored])
